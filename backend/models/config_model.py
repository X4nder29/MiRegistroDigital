...
DEFAULTS: dict[str, Any] = {
    "scanner":      {"dpi": 300, "color_mode": "color", "source": "", "auto_feeder": False},
    "correction":   {"auto_perspective": True, "auto_rotation": True},
    "ocr":          {"languages": ["es", "en"], "margin_right_pct": 0.15,
                     "confidence_threshold": 0.4, "gpu": False},
...
class ConfigModel:
    ...
    def _merge(base: dict, override: dict) -> dict:
        ...
        for k, v in override.items():
            r[k] = ConfigModel._merge(r[k], v) if (k in r and isinstance(r[k], dict) and isinstance(v, dict)) else v
        return r
